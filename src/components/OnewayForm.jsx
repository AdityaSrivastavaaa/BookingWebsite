...
function OnewayForm() {
  ...
  return (
    ...
    <form className="w-full border mx-auto p-4">
        ...
        <div className='mb-5 className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"'>
        <input type="date" />
        </div>
